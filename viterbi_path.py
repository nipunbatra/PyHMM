...
def path(prior,transition_matrix,emission_matrix,observation_vector):
    ...
    return optimum_path[:500],delta[0][1:550]
...
observed_sequence=np.random.randint(2,size=10000)
